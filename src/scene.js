...
import { otherControl } from "./base/pid.js";
import { Bobcat, Lynx } from "./base/ship.js";
        ...
        for (let o of this.otherShips) {
          ...
          if (collisioning == 1) {
            ...
            if (b.kind === "kEmpBlast") {
              ...
              o.disabled =
                performance.now() + window.settings.player.empDuration;
...
function triggerTextEffect(kind, x_, y_, scale) {
  ...
  const rect = effectText.getBoundingClientRect();
